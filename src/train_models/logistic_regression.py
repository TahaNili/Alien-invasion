"""Train a Logistic Regression model on recorder CSV data and save it to models/"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out', help='Output model path', default='models/logistic_regression.joblib')
